...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form action="{{ route('timpp2.asets.update', ['uuid' => $aset->uuid]) }}" method="POST">
            <div class="row">
                @csrf
                <div class="col-12">
                    <div>
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="kode_aset" value="{{ $aset->kode_aset }}">
                        </div>
                        <div class="mb-3">
                            <label for="example-text-input" class="form-label">Nama Aset</label>
                            <input class="form-control" type="text" name="nama_aset" value="{{ $aset->nama_aset }}">
                        </div>
                        <div class="mb-3">
                            <label for="example-text-input" class="form-label">Lokasi Aset</label>
                            <input class="form-control" type="text" name="lokasi_aset" value="{{ $aset->lokasi_aset }}">
                        </div>
                        <div class="mb-3">
                            <label for="example-text-input" class="form-label">Status </label>
                            <input class="form-control" type="text" name="status_aset" value="{{ $aset->status_aset }}">
                        </div>
                        <div class="mb-3">
                            <label for="example-text-input" class="form-label">Deskripsi</label>
                            <input class="form-control" type="text" name="deskripsi" value="{{ $aset->deskripsi }}">
                        </div>
                    </div>
                    <!-- end card -->
                </div>
