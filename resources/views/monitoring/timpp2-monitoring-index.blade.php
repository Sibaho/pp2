            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <a href="{{ route('timpp2.monitoring.add') }}" class="btn btn-primary waves-effect waves-light">Add Monitoring</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="datatable" class="table table-bordered table-striped nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('timpp2.monitoring.edit',$item['uuid']) }}" class="btn btn-info waves-effect waves-light">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ route('timpp2.monitoring.delete',$item['uuid']) }}" class="btn btn-danger waves-effect waves-light">
