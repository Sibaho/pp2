    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('timpp2.monitoring.index') }}">Monitoring</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('timpp2.monitoring.update', ['uuid' => $monitoringData->uuid]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('timpp2.monitoring.index') }}" class="btn btn-light me-1">Cancel</a>
